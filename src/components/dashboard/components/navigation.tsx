...
export function Navigation() {
  ...
  const navigationItems = useMemo(
    ...
    [basePath, isDashboardPage, isOrdersPage, isTodayOrdersPage]
  );
            ...
            return (
              <li key={item.href}>
                <Button
                  ...
                  className={`px-3 py-2 rounded-lg text-xs font-medium transition-all duration-200 data-[active=true]:translate-y-[-1px] ${item.isActive ? activeClasses : baseClasses}`}
