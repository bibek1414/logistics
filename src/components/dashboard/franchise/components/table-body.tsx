...
import type { Column, SaleItem } from "@/types/sales";
                ...
                .map((column) => (
                  ...
                  >
                    {column.id === "select" ? (
                      ...
                      <div
                        className="whitespace-normal break-words cursor-pointer hover:underline text-primary"
                        onClick={() => {
                          router.push(`/track-order/${sale.order_code}`);
                        }}
                      >
                        {sale.order_code}
                      </div>
